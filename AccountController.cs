...
namespace RolesDemo.Controllers
{
    ...
    public class AccountController : Controller
    {
         ...
         public async Task<ActionResult> Register(RegisterViewModel model)
         {
             if (ModelState.IsValid)
             {
                 ...
                 if (result.Succeeded)
                 {
                     ...
                     var resultRole = await UserManager.AddToRolesAsync(user.Id, "Public");
        ...
        {
            ViewBag.Message = "RolesDemo Customer Feedback";
        ...
        public async Task<ActionResult> FeedBack(SendEMailViewModel model)
        {
            ...
            await MessageServices.SendEmailAsync("ash786abdulkader@gmail.com", subj, message);
        ...
        {
            ViewBag.Message = "RolesDemo Bug Report";
        ...
        [HttpPost]
        [AllowAnonymous]
        public async Task<ActionResult> BugReport(SendEMailViewModel model)
        {
            var message = await EMailTemplate("BugReportEmail");
            message = message.Replace("@ViewBag.Name", CultureInfo.CurrentCulture.TextInfo.ToTitleCase(model.Name));
            message = message.Replace("@ViewBag.Email", CultureInfo.CurrentCulture.TextInfo.ToTitleCase(model.Email));
            message = message.Replace("@ViewBag.Page", CultureInfo.CurrentCulture.TextInfo.ToTitleCase(model.Page));
        ...
        {
            ViewBag.Message = "Troubleshooting RolesDemo";
